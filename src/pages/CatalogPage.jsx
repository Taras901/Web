...
const Card = styled.div`
  ...
  &:hover { box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); transform: translateY(-2px); transition: 0.2s; }
`;
...
const ActionButtons = styled.div`
  ...
  button {
    flex: 1; padding: 6px; font-size: 0.8rem; border-radius: 4px; cursor: pointer; border: 1px solid transparent; font-weight: 600;
  }
`;
...
const CatalogPage = () => {
  ...
  const handleEdit = async (item) => {
    const newTitle = prompt("Введіть нову назву для товару:", item.title);
